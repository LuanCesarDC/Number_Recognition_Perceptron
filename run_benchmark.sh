...
# === Configurações ===
declare -a HIDDEN_SIZES=(32 64 128) # Tamanhos da camada oculta a testar
declare -a LEARNING_RATES=(0.01 0.1 0.2) # Taxas de aprendizado a testar
declare -a EPOCHS=(5 10 15 30 50)          # Número de épocas a testar
